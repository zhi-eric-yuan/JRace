...
public abstract class AbstractSimplex {
    ...
    public ArrayList<RealPointValuePair> iterationPoints;
    ...
    public void build(final double[] startPoint) {
        ...
        // By default n + 1 points per simplex  
        iterationPoints = new ArrayList<RealPointValuePair>(dimension + 1);
        ...
        for (int i = 0; i < dimension; i++) {
            ...
            log.info("Simplex {} built: {}", i, Arrays.toString(vertexI));
    ...
    public void evaluate(final MultivariateFunction evaluationFunction,
        ...
        for (int i = 0; i < simplex.length; i++) {
            ...
            if (Double.isNaN(vertex.getValue())) {
                simplex[i] = new RealPointValuePair(point, evaluateAndArchive(evaluationFunction, 
                		point), false);
            }
        }
    ...
    protected double evaluateAndArchive(final MultivariateFunction evaluationFunction, 
    		double[] point) {
    	double value = evaluationFunction.value(point);
    	iterationPoints.add(new RealPointValuePair(point, value));
    	return value;
    }
