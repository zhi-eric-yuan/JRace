...
public class NelderMeadSimplex extends AbstractSimplex {
    ...
    public void iterate(final MultivariateFunction evaluationFunction,
        ...
        // there can be at most n + 2 points per simplex iteration: 
        // 1 Reflection, 1 contraction and 2 shrink
        iterationPoints = new ArrayList<RealPointValuePair>(n + 2);
        
        // Interesting values.
        final RealPointValuePair best = getPoint(0);
        final RealPointValuePair secondWorst = getPoint(n - 1);
        final RealPointValuePair worst = getPoint(n);
        final double[] xWorst = worst.getPointRef();
        
       /* RealPointValuePair p1 = getPoint(0);
        RealPointValuePair p2 = getPoint(1);
        RealPointValuePair p3 = getPoint(2);
        System.out.println(p1.getPoint()[0] + " " + p1.getPoint()[1] + "\n" 
        		+ p2.getPoint()[0] + " " + p2.getPoint()[1] + "\n" 
        		+ p3.getPoint()[0] + " " + p3.getPoint()[1] + "\n");*/
        ...
        final RealPointValuePair reflected
            = new RealPointValuePair(xR, evaluateAndArchive(evaluationFunction, xR), false);

        if (comparator.compare(best, reflected) <= 0 &&
            comparator.compare(reflected, secondWorst) < 0) {
            ...
            final RealPointValuePair expanded
                = new RealPointValuePair(xE, evaluateAndArchive(evaluationFunction, xE), false);
            ...
            if (comparator.compare(reflected, worst) < 0) {
                ...
                log.info("outContracted");
               final RealPointValuePair outContracted
                    = new RealPointValuePair(xC, evaluateAndArchive(evaluationFunction, xC), false);
